        ...
        <div class="col-xs-6">
          <div class="box box-warning">
            <div class="box-header">
              <h3 class="box-title">Update Education</h3>
              <?php echo validation_errors(); ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" name="form1" method="post" action="<?php echo base_url() ?>admin/edu/update">
                <!-- judul -->
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="job" placeholder="Study Program ..." value="<?php echo $work['job']; ?>">
                </div>

                <!-- judul -->
                <div class="form-group">
                  <label>University</label>
                  <input type="text" class="form-control" name="company" placeholder="University ..." value="<?php echo $work['company']; ?>">
                </div>
