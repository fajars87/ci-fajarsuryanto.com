      ...
      <div class="row">
        <div class="col-xs-6">
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" name="form1" method="post" action="<?php echo base_url() ?>admin/skill/update">
                <!-- judul -->
                <div class="form-group">
                  <label>Name</label>
                  <input type="text" class="form-control" name="name" placeholder="Name ..." value="<?php echo $skill['name']; ?>">
                </div>

                <!-- judul -->
                <div class="form-group">
                  <label>Progress</label>
                  <input type="text" class="form-control" name="progress" placeholder="Progress ..." value="<?php echo $skill['progress']; ?>">
                </div>
