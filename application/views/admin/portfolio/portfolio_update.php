      ...
      <div class="row">
        <div class="col-xs-4">
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" name="form1" method="post" action="<?php echo base_url() ?>admin/portfolio/update">
                <!-- judul -->
                <div class="form-group">
                  <label>Title</label>
                  <input type="text" class="form-control" name="title" placeholder="Title ..." value="<?php echo $portfolio['title']; ?>">
                </div>
                ...
                <div class="form-group">
                  <label>Detail</label>
                    <div class="box-body pad">
                        <textarea name="detail" rows="3" cols="40" ><?php echo $portfolio['detail']; ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                  <label>Link</label>
                    <div class="box-body pad">
                        <textarea name="link" rows="3" cols="40" ><?php echo $portfolio['link']; ?></textarea>
                    </div>
                </div>
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" name="date" id="datepicker" value="<?php echo $portfolio['date']; ?>">
                </div>
                <!-- /.input group -->
              </div>
